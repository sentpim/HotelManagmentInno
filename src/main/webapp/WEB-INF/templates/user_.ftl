                    ...
                    <div class="card card-user">
                        ...
                        <div class="content">
                            <div class="author">
                                ...
                                <h4 class="title">${user.getEmployee().getPerson().firstName} ${user.getEmployee().getPerson().lastName}<br />
                                     <a href="#"><small>${user.getEmployee().getPerson().email}</small></a>
                                  </h4>
                            </div>
                            <p class="description text-center">
                                ${user.getEmployee().getPost().name}
                                <br>
                            </p>
                        </div>
                        <hr>
                        <div class="text-center">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <h5>${user.getEmployee().salary}$<br /><small>Salary</small></h5>
                                </div>
                            </div>
                        </div>
                    </div>
